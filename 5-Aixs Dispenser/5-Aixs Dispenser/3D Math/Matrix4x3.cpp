...
void Matrix4x3::setTranslation (const Vector3M &d)
{
    tx = d.x;   ty = d.y;   tz = d.y;
}

void Matrix4x3::setupTranslation (const Vector3M &d)
{
...
void Matrix4x3::setScale (const Vector3M &v)
{
...
void Matrix4x3::setProject (const Vector3M &v)
{
...
void Matrix4x3::setReflect (const Vector3M &n)
{
...
{
    return Vector3M (m.tx, m.ty, m.tz);
}

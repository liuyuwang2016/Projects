...
void GetToolData()
{
	int64_t toolId = 0;
	const Frame frame = controller.frame();
	Tool pen_tip = frame.tool(toolId);
	Vector currentPosition = pen_tip.tipPosition();
	cout << "-------------------------------------" << endl;
	cout << "tipPosition.X = " << currentPosition.x << endl;
	cout << "tipPosition.Y = " << currentPosition.y << endl;
	cout << "tipPosition.Z = " << currentPosition.z << endl;
	cout << "-------------------------------------" << endl;
}

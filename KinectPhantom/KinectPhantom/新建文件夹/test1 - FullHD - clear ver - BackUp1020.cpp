...
//Draw Cubic
const float CubicUnitW = 0.1f * 2.5;
const float CubicUnitH = 0.05f * 2.5;
...
void RenderScene()
{
	...
	if (ROIStorageCount != 0)
	{
		...
		//	glPrintf(">>glut(%i, %i)", Start.x - 50, Start.y - 3);
		//	glPrintf("Start");

		//}
		//if (IS_REC_END && !IS_KEY_F1_UP)
		//{
		//	glPrintf(">>glut(%i, %i)", End.x - 50, End.y - 3);
		//	glPrintf("End");
		//}
